...
for task in args.dataset:
    ...
    args.kd_p_weight_annealing[task] = WeightAnnealing(T=int(args.nb_epochs * KD_P_ANNEL[task]))
...
for epoch in range(start_epoch, start_epoch+args.nb_epochs):
    ...
    train_acc, train_loss, kd_f_loss, kd_p_loss = utils_pytorch.trainurl(epoch, train_loaders, training_tasks, net, args, optimizer, adaptors, optimizer_adaptor)
    test_acc, test_loss, best_acc = utils_pytorch.urltest(epoch,val_loaders, all_tasks, net, best_acc, args, optimizer, adaptors, optimizer_adaptor)
